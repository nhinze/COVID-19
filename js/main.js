...
function getData(state_1, state_2) {
    ...
    $.getJSON( "https://api.covidtracking.com/v1/states/" + state_1.toLowerCase() + "/daily.json", function( data ) {
    ...
    $.getJSON( "https://api.covidtracking.com/v1/states/" + state_2.toLowerCase() + "/daily.json", function( data ) {
